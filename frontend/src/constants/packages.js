export const PACKAGES = [
  ...
  {
    id: 'c_blue',
    title: 'Mathematics & Natural Sciences Courses',
    category: 'EDOT CORE',
    color: '#3B82F6',
    darkColor: '#1D4ED8',
    ribbon: 'MATH & SCIENCES',
  ...
  {
    id: 'c_indigo',
    title: 'Technology & Development Courses',
    category: 'EDOT CORE',
    color: '#6366F1',
    darkColor: '#4338CA',
    ribbon: 'TECH & DEVELOPMENT',
  ...
  },
  {
    ...
    color: '#FFD700',
    darkColor: '#CA8A04',
    ribbon: 'BUSINESS & ENTREPRENEURSHIP',
