...
export default function CTA({ 
  ...
  return (
    <section className="py-24 px-6 max-w-5xl mx-auto relative z-20">
      <div className={`backdrop-blur-2xl border rounded-[3rem] p-12 md:p-20 text-center shadow-2xl relative overflow-hidden group ${isDarkMode ? 'bg-[#0B1120]/40 border-white/10' : 'bg-slate-50 border-slate-200'}`}>
