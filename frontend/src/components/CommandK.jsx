    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="overflow-hidden rounded-3xl bg-[#0B0E14]/95 shadow-2xl shadow-[#F97316]/10 border border-[#F97316]/30 backdrop-blur-2xl">
                          ...
                          {items.map((item) => {
                            ...
                            return (
                              <li key={`${item.type}-${item.id || item.title}`}>
                                ...
                                >
                                  <div className={`p-2 rounded-xl transition-colors ${isSelected ? 'bg-[#F97316] text-[#0B0E14]' : 'bg-[#11151F]/5 '} ${isDarkMode ? 'text-slate-300' : 'text-slate-500'}`}>
