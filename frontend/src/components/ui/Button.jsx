...
export function Button({ 
  ...
  const variants = {
    ...
    secondary: isDarkMode ? 'bg-[#11151F] text-white border border-slate-700 shadow-md hover:bg-slate-800' : 'bg-slate-800 text-white shadow-md hover:bg-slate-700 border border-slate-700',
    outline: isDarkMode ? 'bg-[#11151F]/50 backdrop-blur-sm border-indigo-200/20 text-indigo-400 hover:bg-indigo-500/20 border focus:ring-indigo-500' : 'bg-white/50 backdrop-blur-sm border-indigo-200 text-indigo-600 hover:bg-indigo-500/10 border focus:ring-indigo-500',
    ...
    ghost: isDarkMode ? 'bg-transparent text-slate-300 hover:bg-slate-800' : 'bg-transparent text-slate-600 hover:bg-slate-100 backdrop-blur-xl',
  };
