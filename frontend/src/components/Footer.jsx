      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-10 gap-10">
          ...
          <div className="flex flex-col max-w-xs">
            <Link to="/" className="flex items-center gap-4 mb-5">
              <div className="w-12 h-12 bg-white flex items-center justify-center rounded-[14px]">
                <GraduationCap className="w-8 h-8 text-[#0B0E14] stroke-[2.5]" />
              </div>
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-6 flex-1 justify-center">
            <div className="flex flex-col gap-3 border-l-2 border-[#E67E22] pl-4">
          ...
          <div className="shrink-0">
            <Link to="/contact" className={`px-6 py-2.5 border border-[#E67E22] bg-[#E67E22] rounded text-sm font-bold hover:bg-[#CF711F] transition-colors shadow-md ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
              Contact Us
            </Link>
          </div>
        ...
        {/* Divider */}
        <div className="w-full h-1 bg-[#E67E22] rounded-full mb-6"></div>

        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className={`flex flex-wrap items-center gap-6 text-xs font-bold ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
            <a href="tel:+251941177566" className="flex items-center gap-2 hover:text-[#E67E22] transition-colors"><Phone className="w-3.5 h-3.5"/> +251 941 177 566</a>
            <a href="tel:+251962343967" className="flex items-center gap-2 hover:text-[#E67E22] transition-colors"><Phone className="w-3.5 h-3.5"/> +251 962 343 967</a>
          </div>
          
          <div className="flex items-center gap-3">
            <a href="#" className={`w-8 h-8 rounded-full flex items-center justify-center hover:text-[#E67E22] transition-colors ${isDarkMode ? 'text-white' : 'text-slate-900'}`}><Facebook className="w-4 h-4"/></a>
            <a href="#" className={`w-8 h-8 rounded-full flex items-center justify-center hover:text-[#E67E22] transition-colors ${isDarkMode ? 'text-white' : 'text-slate-900'}`}><Youtube className="w-4 h-4"/></a>
            <a href="#" className={`w-8 h-8 rounded-full flex items-center justify-center hover:text-[#E67E22] transition-colors ${isDarkMode ? 'text-white' : 'text-slate-900'}`}><Linkedin className="w-4 h-4"/></a>
            <a href="#" className={`w-8 h-8 rounded-full flex items-center justify-center hover:text-[#E67E22] transition-colors ${isDarkMode ? 'text-white' : 'text-slate-900'}`}><Instagram className="w-4 h-4"/></a>
            <a href="#" className={`w-8 h-8 rounded-full flex items-center justify-center hover:text-[#E67E22] transition-colors ${isDarkMode ? 'text-white' : 'text-slate-900'}`}><Send className="w-4 h-4"/></a>
          </div>
        </div>
