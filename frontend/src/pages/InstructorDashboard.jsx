        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              <div className={`border rounded-2xl p-6 shadow-sm hover:border-white/10 transition-colors ${isDarkMode ? 'bg-[#13161B] border-white/5' : 'bg-white border-slate-100'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
              <div className={`border rounded-2xl p-6 shadow-sm flex flex-col ${isDarkMode ? 'bg-[#13161B] border-white/5' : 'bg-white border-slate-100'}`}>
            ...
            <div className={`mt-8 backdrop-blur-xl p-8 rounded-2xl border shadow-2xl ${isDarkMode ? 'bg-[#0B0E14]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
      ...
      case 'courses':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {courses.length === 0 ? (
               <div className={`bg-[#0B0E14]/50 backdrop-blur-xl p-12 text-center rounded-2xl border-2 border-dashed shadow-sm flex flex-col items-center justify-center ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
                 <div className={`w-20 h-20 rounded-full flex items-center justify-center mb-4 ${isDarkMode ? 'bg-[#11151F]/5 text-slate-300' : 'bg-slate-50 text-slate-500'}`}>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {courses.map(c => (
                    <div key={c.id} className={`backdrop-blur-xl rounded-2xl border shadow-2xl overflow-hidden flex flex-col md:flex-row group transition-all hover:border-[#FFD700]/30 relative ${isDarkMode ? 'bg-[#0B0E14]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
                      ...
                      <div className="w-full md:w-64 h-48 md:h-auto shrink-0 relative bg-[#11151F]">
                        ...
                        />
                         <div className={`absolute top-3 left-3 backdrop-blur-sm px-3 py-1.5 rounded-md text-[9px] font-black text-[#FFD700] border ${isDarkMode ? 'bg-[#0B0E14]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
                           {c.category}
                         </div>
                      </div>
                      ...
                      <div className="flex flex-col flex-1 relative z-10">
                        ...
                        <div className={`p-4 md:px-8 border-t flex flex-col sm:flex-row justify-between items-center gap-4 ${isDarkMode ? 'border-white/10 bg-[#11151F]/50' : 'border-slate-200 bg-slate-100'}`}>
                             ...
                             {(c.status === 'draft' || c.status === 'rejected') && (
                               <>
                                 <button 
                                  ...
                                  className={`flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-6 py-2.5 font-bold text-[10px] rounded-lg border hover:bg-[#FFD700] hover:text-[#0B0E14] hover:border-[#FFD700] transition-colors ${isDarkMode ? 'bg-[#11151F]/5 text-white border-white/10' : 'bg-slate-50 text-slate-900 border-slate-200'}`}
                                 >
      ...
      case 'create':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl">
            ...
            <div className={`backdrop-blur-xl p-6 md:p-8 rounded-3xl border shadow-2xl relative overflow-hidden ${isDarkMode ? 'bg-[#0B0E14]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
              ...
              <form onSubmit={handleCreateCourse} className="space-y-6 relative z-10">
                ...
                <div>
                  ...
                  <input 
                    ...
                    required 
                    className={`w-full px-6 py-4 bg-[#11151F] font-bold border rounded-xl focus:ring-2 focus:ring-[#FFD700] focus:border-transparent outline-none transition-all placeholder:text-slate-300 ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    required 
                    className={`w-full px-6 py-4 bg-[#11151F] font-medium border rounded-xl focus:ring-2 focus:ring-[#FFD700] focus:border-transparent outline-none transition-all resize-y placeholder:text-slate-300 ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                    rows="5" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      required 
                      className={`w-full px-6 py-4 bg-[#11151F] font-bold border rounded-xl focus:ring-2 focus:ring-[#FFD700] focus:border-transparent outline-none transition-all ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className={`w-full px-6 py-4 bg-[#11151F] font-medium border rounded-xl focus:ring-2 focus:ring-[#FFD700] focus:border-transparent outline-none transition-all placeholder:text-slate-300 ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                ...
                <div className={`pt-8 border-t flex flex-col sm:flex-row gap-4 justify-end ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
                   <button 
                    ...
                    className={`px-8 py-3.5 bg-transparent font-black text-[11px] rounded-xl border hover:bg-[#11151F]/5 hover:text-white transition-all order-2 sm:order-1 ${isDarkMode ? 'text-slate-200 border-white/10' : 'text-slate-600 border-slate-200'}`}
                   >
                     Abort Setup
                   </button>
                   <button 
    ...
    <div className={`min-h-screen bg-[#0d0f12] flex flex-col md:flex-row font-sans ${isDarkMode ? 'text-slate-300' : 'text-slate-500'}`}>
      ...
      {activeCourseId && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 sm:px-0">
          <div className={`absolute inset-0 backdrop-blur-md ${isDarkMode ? 'bg-[#0B0E14]/80' : 'bg-white/90'}`} onClick={() => setActiveCourseId(null)}></div>
          
          <div className={`bg-[#11151F] border rounded-3xl w-full max-w-xl shadow-2xl relative z-10 animate-in zoom-in-95 duration-200 ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
            <div className={`flex justify-between items-center p-8 border-b ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
              ...
              <button 
                ...
                className={`w-10 h-10 flex items-center justify-center rounded-xl hover:bg-[#11151F]/10 hover:text-white transition-colors ${isDarkMode ? 'bg-[#11151F]/5 text-slate-200' : 'bg-slate-50 text-slate-600'}`}
              >
                &times;
              </button>
            </div>
            ...
            <form onSubmit={handleAddLesson} className="p-8 space-y-6">
              <div>
                ...
                <input 
                  ...
                  required 
                  className={`w-full px-6 py-4 font-bold border rounded-xl focus:ring-2 focus:ring-[#FFD700] outline-none transition-all placeholder:text-slate-300 ${isDarkMode ? 'bg-[#0B0E14] text-white border-white/10' : 'bg-white text-slate-900 border-slate-200'}`} 
              ...
              <div>
                ...
                <textarea 
                  ...
                  required 
                  className={`w-full px-6 py-4 font-medium border rounded-xl focus:ring-2 focus:ring-[#FFD700] outline-none transition-all resize-none placeholder:text-slate-300 ${isDarkMode ? 'bg-[#0B0E14] text-white border-white/10' : 'bg-white text-slate-900 border-slate-200'}`} 
                  rows="3" 
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="w-full sm:w-32 shrink-0">
                  ...
                  <input 
                    ...
                    required 
                    className={`w-full px-6 py-4 font-black border rounded-xl focus:ring-2 focus:ring-[#FFD700] outline-none transition-all text-center ${isDarkMode ? 'bg-[#0B0E14] text-white border-white/10' : 'bg-white text-slate-900 border-slate-200'}`} 
                  />
                </div>
              </div>
              ...
              <div className={`pt-8 border-t flex gap-4 ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
                <button 
                  type="button" 
                  onClick={() => setActiveCourseId(null)}
                  className={`flex-1 py-4 px-6 bg-transparent font-black text-[11px] rounded-xl border hover:bg-[#11151F]/5 hover:text-white transition-all shadow-sm ${isDarkMode ? 'text-slate-200 border-white/10' : 'text-slate-600 border-slate-200'}`}
                >
                  Terminate
                </button>
                <button 
