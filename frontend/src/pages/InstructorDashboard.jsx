        ...
        return (
          <div className="animate-in fade-in flex flex-col space-y-8 min-h-screen p-6 md:p-10 max-w-7xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
              <div className={`border rounded-2xl p-6 shadow-sm flex flex-col ${isDarkMode ? 'bg-[#0B1120] border-white/5' : 'bg-white border-slate-100'}`}>
            ...
            <div className={`mt-8 backdrop-blur-xl p-8 rounded-2xl border shadow-2xl ${isDarkMode ? 'bg-[#0B1120]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
      ...
      case 'courses':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {courses.length === 0 ? (
               <div className={`bg-[#0B1120]/50 backdrop-blur-xl p-12 text-center rounded-2xl border-2 border-dashed shadow-sm flex flex-col items-center justify-center ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {courses.map(c => (
                    <div key={c.id} className={`backdrop-blur-xl rounded-2xl border shadow-2xl overflow-hidden flex flex-col md:flex-row group transition-all hover:border-[#F97316]/30 relative ${isDarkMode ? 'bg-[#0B1120]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
                      ...
                      <div className={`w-full md:w-64 h-48 md:h-auto shrink-0 relative ${isDarkMode ? 'bg-[#0B1120]' : 'bg-slate-100'}`}>
                        ...
                        />
                         <div className={`absolute top-3 left-3 backdrop-blur-sm px-3 py-1.5 rounded-md text-[9px] font-black text-[#F97316] border ${isDarkMode ? 'bg-[#0B1120]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
                           {c.category}
                         </div>
                      </div>
                             ...
                             {(c.status === 'draft' || c.status === 'rejected') && (
                               <>
                                 <button 
                                  ...
                                  className={`flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-6 py-2.5 font-bold text-[10px] rounded-lg border hover:bg-[#F97316] hover:text-white hover:border-[#F97316] transition-colors ${isDarkMode ? 'bg-[#0B1120]/5 text-white border-white/10' : 'bg-slate-50 text-slate-900 border-slate-200'}`}
                                 >
              ...
              <form onSubmit={handleCreateCourse} className="space-y-6 relative z-10">
                ...
                <div>
                  ...
                  <input 
                    ...
                    required 
                    className={`w-full px-6 py-4 bg-[#0B1120] font-bold border rounded-xl focus:ring-2 focus:ring-[#F97316] focus:border-transparent outline-none transition-all placeholder:text-slate-300 ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    required 
                    className={`w-full px-6 py-4 bg-[#0B1120] font-medium border rounded-xl focus:ring-2 focus:ring-[#F97316] focus:border-transparent outline-none transition-all resize-y placeholder:text-slate-300 ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                    rows="5" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      required 
                      className={`w-full px-6 py-4 bg-[#0B1120] font-bold border rounded-xl focus:ring-2 focus:ring-[#F97316] focus:border-transparent outline-none transition-all ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className={`w-full px-6 py-4 bg-[#0B1120] font-medium border rounded-xl focus:ring-2 focus:ring-[#F97316] focus:border-transparent outline-none transition-all placeholder:text-slate-300 ${isDarkMode ? 'text-white border-white/10' : 'text-slate-900 border-slate-200'}`} 
    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-[#0B1120]' : 'bg-[#FAFAFA]'} flex flex-col md:flex-row font-sans ${isDarkMode ? 'text-slate-300' : 'text-slate-500'}`}>
      ...
      {activeCourseId && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 sm:px-0">
          ...
          <div className={`bg-[#0B1120] border rounded-3xl w-full max-w-xl shadow-2xl relative z-10 animate-in zoom-in-95 duration-200 ${isDarkMode ? 'border-white/10' : 'border-slate-200'}`}>
