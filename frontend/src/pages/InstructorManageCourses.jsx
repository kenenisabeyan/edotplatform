    ...
    >
      ...
      {courses.length === 0 ? (
          <div className={`p-16 text-center rounded-3xl border shadow-2xl backdrop-blur-xl flex flex-col items-center justify-center relative overflow-hidden group ${isDarkMode ? 'border-white/10 bg-[#1E293B]/90' : 'border-slate-200 bg-white/95'}`}>
            ...
            <div className={`w-24 h-24 border rounded-full flex items-center justify-center mb-6 relative group-hover:scale-110 transition-transform duration-500 group-hover:border-[#E67E22]/30 group-hover:text-[#E67E22] ${isDarkMode ? 'bg-[#1E293B]/5 text-slate-200 border-white/10' : 'bg-slate-50 text-slate-600 border-slate-200'}`}>
                         ...
                         <div className={`mt-auto flex flex-col gap-3 pt-4 border-t ${isDarkMode ? 'border-white/5' : 'border-slate-100'}`}>
                           ...
                           {c.status !== 'pending' && (
                             <button 
                               ...
                               className={`w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 font-bold rounded-xl border hover:bg-[#FFD700] hover:text-[#0B0E14] hover:border-[#FFD700] transition-colors shadow-sm text-xs ${isDarkMode ? 'bg-[#1E293B]/5 text-white border-white/10' : 'bg-slate-50 text-slate-900 border-slate-200'}`}
                             >
        ...
        {modalType && activeCourse && (
          ...
          >
            <motion.div 
              ...
              className={`w-full max-w-2xl border border-[#FFD700]/20 rounded-3xl p-6 shadow-[0_0_50px_rgba(255,215,0,0.1)] relative overflow-hidden flex flex-col max-h-[85vh] ${isDarkMode ? 'bg-[#1E293B]' : 'bg-white'}`}
            >
                ...
                {modalType === 'lessons' && (
                  activeCourse.lessons?.length === 0 ? (
                    ...
                    activeCourse.lessons.map((l, index) => (
                      <div key={l.id || index} className={`flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-2xl border hover:border-[#FFD700]/30 transition-colors group ${isDarkMode ? 'bg-[#1E293B]/5 border-white/10' : 'bg-slate-50 border-slate-200'}`}>
