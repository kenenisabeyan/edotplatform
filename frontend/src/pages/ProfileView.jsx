    ...
    <div className="animate-in fade-in max-w-3xl mx-auto space-y-6">
      ...
      <div className={`backdrop-blur-xl rounded-3xl border shadow-2xl overflow-hidden ${isDarkMode ? 'bg-[#0B0E14]/90 border-white/10' : 'bg-white/95 border-slate-200'}`}>
        ...
        <div className="px-8 pb-8 relative">
           ...
           <div className={`absolute -top-20 border-4 rounded-full w-36 h-36 flex items-center justify-center overflow-hidden group shadow-[0_0_20px_rgba(255,215,0,0.2)] ${isDarkMode ? 'border-[#0B0E14] bg-[#11151F]' : 'border-white bg-slate-100'}`}>
             ...
             <form onSubmit={handleUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative border rounded-xl overflow-hidden focus-within:ring-1 transition-all ${isDarkMode ? 'border-white/10 focus-within:border-[#FFD700]/50 focus-within:ring-[#FFD700]/50' : 'border-slate-300 focus-within:border-indigo-500 focus-within:ring-indigo-500'}`}>
                    ...
                    <input 
                      ...
                      className={`w-full pl-12 pr-4 py-3 font-medium outline-none placeholder:text-slate-300 ${isDarkMode ? 'bg-[#11151F] text-white' : 'bg-white text-slate-900'}`} 
                      required 
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative border rounded-xl overflow-hidden opacity-50 ${isDarkMode ? 'border-white/5 bg-transparent text-slate-200' : 'border-slate-200 bg-slate-50 text-slate-600'}`}>
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      disabled
                      className="w-full pl-12 pr-4 py-3 bg-transparent font-medium cursor-not-allowed outline-none" 
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative border rounded-xl overflow-hidden focus-within:ring-1 transition-all ${isDarkMode ? 'border-white/10 focus-within:border-[#FFD700]/50 focus-within:ring-[#FFD700]/50' : 'border-slate-300 focus-within:border-indigo-500 focus-within:ring-indigo-500'}`}>
                    ...
                    <CustomDropdown 
                      ...
                      className={`w-full [&>button]:pl-12 [&>button]:py-3 [&>button]:border-none [&>button]:font-medium ${isDarkMode ? '[&>button]:bg-[#11151F] [&>button]:text-white' : '[&>button]:bg-white [&>button]:text-slate-900'}`}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className={`relative border rounded-xl overflow-hidden focus-within:ring-1 transition-all ${isDarkMode ? 'border-white/10 focus-within:border-[#FFD700]/50 focus-within:ring-[#FFD700]/50' : 'border-slate-300 focus-within:border-indigo-500 focus-within:ring-indigo-500'}`}>
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      className={`w-full pl-12 pr-4 py-3 font-medium outline-none ${isDarkMode ? 'bg-[#11151F] text-white color-scheme-dark' : 'bg-white text-slate-900'}`} 
                    />
                  </div>
                </div>
                ...
                {user?.role === 'student' && (
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className={`relative border rounded-xl overflow-hidden focus-within:ring-1 transition-all ${isDarkMode ? 'border-white/10 focus-within:border-emerald-500/50 focus-within:ring-emerald-500/50' : 'border-slate-300 focus-within:border-emerald-500 focus-within:ring-emerald-500'}`}>
                      <Phone className={`absolute left-4 top-3.5 w-5 h-5 ${isDarkMode ? 'text-slate-300' : 'text-slate-500'}`} />
                      <input 
                        type="text" 
                ...
                {user?.role === 'parent' && (
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className={`relative border rounded-xl overflow-hidden focus-within:ring-1 transition-all ${isDarkMode ? 'border-white/10 focus-within:border-purple-500/50 focus-within:ring-purple-500/50' : 'border-slate-300 focus-within:border-purple-500 focus-within:ring-purple-500'}`}>
                      <Briefcase className={`absolute left-4 top-3.5 w-5 h-5 ${isDarkMode ? 'text-slate-300' : 'text-slate-500'}`} />
                      <input 
                        type="text" 
                        name="occupation"
