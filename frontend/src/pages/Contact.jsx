      ...
      <div className="relative z-10 pt-24">
        ...
        <section className={`py-24 px-6 border-b ${isDarkMode ? 'bg-[#0B1120] border-white/5' : 'bg-white border-slate-200'}`}>
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
             ...
             <div className="lg:col-span-7">
               <div className={`p-8 md:p-12 rounded-3xl border shadow-xl relative overflow-hidden h-full ${isDarkMode ? 'bg-[#11151F] border-white/10' : 'bg-white border-slate-200'}`}>
        ...
        <section className={`py-24 px-6 border-b ${isDarkMode ? 'bg-[#0F172A] border-white/5' : 'bg-slate-50 border-slate-200'}`}>
           <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Partnership */}
              <div className={`p-10 rounded-3xl border flex flex-col justify-between relative overflow-hidden group ${isDarkMode ? 'bg-[#11151F] border-white/10 hover:border-white/20' : 'bg-white border-slate-200 hover:border-[#EBC176]/50'} transition-colors`}>
              ...
              {/* Quick Help */}
              <div className={`p-10 rounded-3xl border flex flex-col justify-between relative overflow-hidden group ${isDarkMode ? 'bg-[#11151F] border-white/10 hover:border-white/20' : 'bg-white border-slate-200 hover:border-blue-500/50'} transition-colors`}>
                 <div className="relative z-10">
