...
export default function Courses() {
  ...
  return (
    <div style={{ backgroundColor: isDarkMode ? '#0B0F19' : '#ffffff' }} className={`min-h-screen w-full font-sans overflow-x-hidden relative transition-colors duration-300 ${isDarkMode ? 'text-slate-100' : 'text-slate-800'}`}>
